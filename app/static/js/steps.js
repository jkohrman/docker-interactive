  ...
  q.push({
    ...
    intermediateresults: [
      function() {
        ...
        $('#tips, #command').hide();
        $('#instructions .text').html("<div class=\"complete\">\n  <h3>Congratulations!</h3>\n  <p>You have mastered the basic docker commands!</p>\n\n\n  <h3>Next steps</h3>\n  <p>Continue to learn about Docker and containers here:</p><p><a target='_blank' rel='noopener noreferrer' href=\"https://docs.docker.com/docker-for-windows/\" class='btn btn-primary secondary-action-button'>Docker for Windows</a></p>\n<p><a target='_blank' rel='noopener noreferrer' href=\"https://docs.docker.com/docker-for-mac/\" class='btn btn-primary secondary-action-button'>Docker for Mac</a></p>\n<p><a target='_blank' rel='noopener noreferrer' href=\"https://prakhar.me/docker-curriculum/\" class='btn btn-primary secondary-action-button'><i>(Unofficial)<i> Docker for Beginners</a></p>\n</div>");
        data = {
